...
namespace Destruction
{
    ...
    public class DestructiblePiece : MonoBehaviour
    {
        #region Fields
        [Header("State")]
        [SerializeField] private PieceState _currentState = PieceState.Intact; // Mặc định là Intact
        ...
        public PieceState CurrentState => _currentState;
        ...
        {
            if (_currentState == PieceState.Intact)
            {
                _currentState = PieceState.Falling;
